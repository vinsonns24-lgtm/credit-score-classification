...
from preprocessing_aws import VALID_RANGES as R

# Batas input form mengikuti rentang wajar yang dipakai saat training (preprocessing_aws.py).
# Nilai di luar rentang ini dianggap salah input oleh endpoint, jadi form tidak mengizinkannya.
...
with col1:
    ...
    age            = st.number_input("Umur",                        18, R["Age"][1], 34)
...
with col2:
    ...
    num_of_loan    = st.number_input("Jumlah Pinjaman",         0, R["Num_of_Loan"][1],       2)
